...
namespace MultiFilling.RiserTuning
{
    partial class RiserStatusControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.stateStartButton = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateBigValve = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateSmallValve = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateReady = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateWorkPosition = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateCheckGround = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateCheckLevel = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateHandButton = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateAlarmLevel = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateAlarmLevelMax = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateAlarmLevelMin = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateAnalogLevelMax = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateAnalogLevelMin = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateStopButton = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateReadyError = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateBigValveError = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateSmallValveError = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateGroundError = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stateLevelError = new MultiFilling.SystemStatus.UcRiserOneState();
            this.commandOpenBigValve = new MultiFilling.SystemStatus.UcRiserOneState();
            this.commandOpenSmallValve = new MultiFilling.SystemStatus.UcRiserOneState();
            this.commandGreenLampOn = new MultiFilling.SystemStatus.UcRiserOneState();
            this.commandBlueLampOn = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind0 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind1 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind2 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind3 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind4 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind5 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind6 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind7 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind8 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind9 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind10 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind11 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind12 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind13 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind14 = new MultiFilling.SystemStatus.UcRiserOneState();
            this.stopKind15 = new MultiFilling.SystemStatus.UcRiserOneState();
