...
namespace MultiFilling.RiserTuning
{
	partial class RiserTuningLinkControl
	{
		...
		private void InitializeComponent()
		{
            ...
            this.label3.Size = new System.Drawing.Size(490, 71);
            this.label3.TabIndex = 3;
            this.label3.Text = "          Внимание! Установка приводит к изменению параметров связи устройства. Д" +
    "ля восстановления связи измените настройки MOXA.";
            // 
            // tableLayoutPanel2
            // 
